# **Fixes/improvements by pftq to base Hunyuan I2V code**
 ...
 - **Major** New multi-GPU temporal parallelization to avoid resizing/divisibility issues, use via "--use-temporal-parallelization". See: https://github.com/Tencent/HunyuanVideo-I2V/issues/35
